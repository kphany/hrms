...
class Employee(models.Model):
    ...
    staff_id = models.CharField(max_length=10, unique=True, editable=True, default='AG-0000')

    def save(self, *args, **kwargs):
        if not self.staff_id or self.staff_id == 'AG-0000':
            self.staff_id = self.generate_staff_id()
        super().save(*args, **kwargs)

    def generate_staff_id(self):
        last_employee_id = Employee.objects.aggregate(models.Max('id'))['id__max'] or 0
        return f"AG-{last_employee_id + 1:04d}"

    first_name = models.CharField(max_length=30, default='John')
    last_name = models.CharField(max_length=30, default='Unassigned')
    email = models.EmailField(max_length=254, default='default@example.com')
    phone = models.CharField(max_length=15, blank=True, null=True)
    department = models.ForeignKey(Department, on_delete=models.CASCADE)
    job_title = models.CharField(max_length=50, default='Unassigned')
